...
const DeliveryDetailPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            ...
            .find({ query: { $limit: 10000 , deliveryId : urlParams.singleCustomersId ,productId : urlParams.singleProductServicesId ,variationId : urlParams.singleVariationsId  , $populate : [
                {
                path: "createdBy",
                service: "users",
                select: ["name"],
