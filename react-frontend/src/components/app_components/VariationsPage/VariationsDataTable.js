...
<Column field="imagePath" header="image_path" body={file_uploadTemplate6} filter={selectedFilterFields.includes("imagePath")} hidden={selectedHideFields?.includes("imagePath")}  sortable style={{ minWidth: "8rem" }} />
