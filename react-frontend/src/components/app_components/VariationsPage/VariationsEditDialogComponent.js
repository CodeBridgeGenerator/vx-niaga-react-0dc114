...
imagePath: _entity?.imagePath,
        ...
        await client.service("variations").patch(_entity._id, _data);
...
<div className="col-12 field">
                <span className="align-items-center">
                    ...
                    <UploadFilesToS3 type={'edit'} setValByKey={setValByKey} onSave={onSave} id={urlParams.singleVariationsId} serviceName="variations" />
                </span>
                <small className="p-error">
