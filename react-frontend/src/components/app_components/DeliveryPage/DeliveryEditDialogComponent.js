...
deliveryDate: _entity?.deliveryDate,
        ...
        await client.service("delivery").patch(_entity._id, _data);
...
<div className="col-12 field">
                <span className="align-items-center">
                    ...
                    <UploadFilesToS3 type={'edit'} setValByKey={setValByKey} onSave={onSave} id={urlParams.singleDeliveryId} serviceName="delivery" />
                </span>
                <small className="p-error">
