...
const InvoiceProductsPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            ...
            .find({ query: { $limit: 10000 , invoiceId : urlParams.singleInvoicesId ,productId : urlParams.singleProductServicesId ,variationId : urlParams.singleVariationsId  , $populate : [
                {
                path: "createdBy",
                service: "users",
                select: ["name"],
