...
const [productId, setProductId] = useState([])
    ...
    const onSave = async () => {
        if(!validate()) return;
        let _data = {
            branchId: _entity?.branchId?._id,productId: _entity?.productId?._id,
        ...
        props.onHide();
        props.alert({ type: "success", title: "Create info", message: "Info Product Branches updated successfully" });
