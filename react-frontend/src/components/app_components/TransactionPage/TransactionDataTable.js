...
const dropdownTemplate3 = (rowData, { rowIndex }) => <p >{rowData.branchId?.name}</p>
...
<Column field="branchId" header="Branch" body={dropdownTemplate3} filter={selectedFilterFields.includes("branchId")} hidden={selectedHideFields?.includes("branchId")}  style={{ minWidth: "8rem" }} />
