...
const PurchaseProductPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            ...
            .find({ query: { $limit: 10000 , branchId : urlParams.singleBranchesId ,purchaseId : urlParams.singlePurchaseId ,productId : urlParams.singleProductServicesId ,variationId : urlParams.singleVariationsId  , $populate : [
                {
                path: "createdBy",
                service: "users",
                select: ["name"],
