...
const dropdownTemplate2 = (rowData, { rowIndex }) => <p >{rowData.productId?.name}</p>
const dropdownTemplate3 = (rowData, { rowIndex }) => <p >{rowData.variationId?.name}</p>
...
<Column field="productId" header="Product" body={dropdownTemplate2} filter={selectedFilterFields.includes("productId")} hidden={selectedHideFields?.includes("productId")}  style={{ minWidth: "8rem" }} />
<Column field="variationId" header="Variation" body={dropdownTemplate3} filter={selectedFilterFields.includes("variationId")} hidden={selectedHideFields?.includes("variationId")}  style={{ minWidth: "8rem" }} />
