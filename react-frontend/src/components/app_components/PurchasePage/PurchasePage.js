...
const PurchasePage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("purchase")
            .find({ query: { $limit: 10000 , branchId : urlParams.singleBranchesId ,vendorId : urlParams.singleVendorsId ,warehouseId : urlParams.singleWarehousesId ,purchaseType : urlParams.singlePurchaseTypeId ,categoryId : urlParams.singleCategoriesId  , $populate : [
                {
                path: "createdBy",
                service: "users",
                select: ["name"],
