...
const NewsCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        ...
        props.onHide();
        props.alert({ type: "success", title: "Create info", message: "Info News updated successfully" });
...
<div className="col-12 field">
                <span className="align-items-center">
                    ...
                    <UploadFilesToS3 type={'create'} setValByKey={setValByKey} onSave={onSave} id={urlParams.singleNewsId} serviceName="news" />
                </span>
                <small className="p-error">
