...
const [projectId, setProjectId] = useState([])
    ...
    const onSave = async () => {
        if(!validate()) return;
        let _data = {
            userId: _entity?.userId?._id,projectId: _entity?.projectId?._id,isActive: _entity?.isActive || false,
        ...
        props.onHide();
        props.alert({ type: "success", title: "Create info", message: "Info Project User updated successfully" });
