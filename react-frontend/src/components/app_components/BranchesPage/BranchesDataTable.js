...
const dropdownArrayTemplate1 = (rowData, { rowIndex }) => <p >{rowData.status}</p>
...
<Column field="status" header="status" body={dropdownArrayTemplate1} filter={selectedFilterFields.includes("status")} hidden={selectedHideFields?.includes("status")}  style={{ minWidth: "8rem" }} />
