...
const UnitCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        if(!validate()) return;
        let _data = {
            branchId: _entity?.branchId?._id,name: _entity?.name,description: _entity?.description,
        ...
        props.onHide();
        props.alert({ type: "success", title: "Create info", message: "Info Unit updated successfully" });
