...
<Column field="postalCode1" header="postal_code.1" body={p_numberTemplate13} filter={selectedFilterFields.includes("postalCode1")} hidden={selectedHideFields?.includes("postalCode1")}  sortable style={{ minWidth: "8rem" }} />
