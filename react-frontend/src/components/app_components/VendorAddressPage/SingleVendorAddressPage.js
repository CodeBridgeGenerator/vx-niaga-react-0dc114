...
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">postal_code.1</label><p className="m-0 ml-3" >{Number(_entity?.postalCode1)}</p></div>
