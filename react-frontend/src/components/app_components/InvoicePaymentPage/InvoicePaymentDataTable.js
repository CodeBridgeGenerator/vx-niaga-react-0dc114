...
<Column field="invoiceId" header="Invoice" body={dropdownTemplate1} filter={selectedFilterFields.includes("invoiceId")} hidden={selectedHideFields?.includes("invoiceId")}  style={{ minWidth: "8rem" }} />
