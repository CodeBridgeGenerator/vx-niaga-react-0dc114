...
image: _entity?.image,
        ...
        await client.service("categories").patch(_entity._id, _data);
...
<div className="col-12 field">
                <span className="align-items-center">
                    ...
                    <UploadFilesToS3 type={'edit'} setValByKey={setValByKey} onSave={onSave} id={urlParams.singleCategoriesId} serviceName="categories" />
                </span>
                <small className="p-error">
